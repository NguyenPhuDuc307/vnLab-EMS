        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TDHV = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BHXH = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    BHYT = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SoPhep = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LastDayOfMoth = table.Column<int>(type: "int", nullable: false),
                    TongNgayCong = table.Column<int>(type: "int", nullable: false),
                    NghiCoPhep = table.Column<int>(type: "int", nullable: false),
                    NghiKhongPhep = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LuongChinh = table.Column<int>(type: "int", nullable: false),
                    PhuCap = table.Column<int>(type: "int", nullable: false),
                    TienThuong = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalarySheets_TimeSheets_TimeSheetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalarySheets_TimeSheetId",
                table: "SalarySheets",
                column: "TimeSheetId");
